...
INSERT INTO site_carousel_slides (tag, title, description, color_slug, sort_order) VALUES
  ...
  ('Fabrication', 'Moulé et gravé à Cannes', 'A quelques pas de Grasse, capitale mondiale du parfum.', 'fume', 4)
...
INSERT INTO site_content (key, value) VALUES
  ...
  ('heroParagraph', 'Chaque bougie Ice Candle est un verre moulé, puis gravé au laser avec votre texte et votre motif — et pensé pour être rechargé à vie. Composez la vôtre ci-dessous, et faites-la tourner sous tous les angles.'),
  ...
  ('processStep1Desc', 'Chaque contenant est moulélé et teinté. Aucune bulle, aucun reflet ne se répète jamais tout à fait.'),
